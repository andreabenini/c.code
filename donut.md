...
# Have a donut.
All credits to: https://www.a1k0n.net/2006/09/15/obfuscated-c-donut.html

## Sep 15, 2006
compile with `gcc -o donut donut.c -lm`, it needs ANSI- or VT100-like emulation
...
# Reloaded
But even: https://www.a1k0n.net/2006/09/20/obfuscated-c-donut-2.html

## Sep 20, 2006
always compile with `gcc -o donut donut.c -lm`, still needs ANSI- or VT100-like emulation
```c
...
...btw first demo is far better and clean
