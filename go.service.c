 ...
 * 
 * Usage: ./bin/service --pidfile ./run/my.pid --user ben --group users --rundir ../ -- ./rootdir --path="." --log="DEBUG"
 *
 * @see
 *     Used with go microservices or daemons
 *
 * @see
 *     Based on Alexandre Fiori Work, credits to him reported below for its original work
 *     Slightly modified to better fit in my case, keeping it simple and working without too many options
 *
 * @see
 *     Original Copyright 2013-2016 Alexandre Fiori
...
void usage() {
    printf(
    "Use: service [options] [--] program [arguments]\n"
    "Options:\n"
